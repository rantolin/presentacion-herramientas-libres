...
\lstdefinestyle{shell}{
   ...
   morekeywords={lasinfo,lasdiff,lasmerge,las2txt,txt2las,las2ogr,laszip,
    ...
    las2las, lastile, lasground, lasheight, lasclassify, info, translate, query, pipeline, spdtranslate, spdrmnoise, spdpmfgrd, spdmccgrd, spddefheight,
    spdinterp, spdmetrics, interp, relup, topo, height, dtm, dsm},
   keywordstyle=\bfseries\color{ZurichBlue},
